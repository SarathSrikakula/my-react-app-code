...
export default function App() {
  return (
    ...
    <Box sx={{
      ...
      >
        {/* Header Columns */}
        <Grid item xs={2} sm={2.5}>State</Grid>
        <Grid item xs={3} sm={3}>State Effective Date</Grid>
        <Grid item xs={3} sm={3}>State Employer Code</Grid>
        <Grid item xs={4} sm={3.5}>Bureau ID</Grid>
      </Grid>
      ...
      {data.map((row, index) => (
        ...
        >
          {/* Data Cells */}
          <Grid item xs={12} sm={2.5} sx={{ fontWeight: { xs: 'bold', sm: 'normal' } }}>
      ...
      >
        <Button
          ...
          sx={{
            ...
            width: '5rem', // Fixed width for circular shape
            height: '5rem', // Fixed height for circular shape
            minWidth: 'unset', // Override Material-UI's min-width
            p: 0, // Remove padding
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            fontSize: '0.75rem', // Adjust font size for 'Edit' to fit
